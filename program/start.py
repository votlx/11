...
@Client.on_message(command("staart") & filters.private & ~filters.edited)
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""Programmer [VOTLX](https://t.me/VOTLZ) 𖡼\nᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ 𖡼\nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𖡼""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("VOTLX", url=f"https://t.me/VOTLZ"),
            ],
            [
                InlineKeyboardButton(
                    "-DIAMOND .", url=f"https://t.me/T_8_T_T"
                ),
            ],
            [
                InlineKeyboardButton("♡اضف البوت الى مجموعتك♡", url=f"https://t.me/Kin_13bot?startgroup=true"),
            ]
         ]
     )
  )
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("𓌹VOTLX", url=f"https://t.me/VOTLZ"),
            ],
            [
                InlineKeyboardButton(
